      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-12">
          <div className="text-justify">
            ...
            called Mage. 20 years old and on his way
            academic degree in Informatics Engineering at Hasanuddin University.<br />
            <br />
            As a curious person, I see the world
            as a field of unlimited exploration. Communication is key, and
            I feel comfortable interacting with people from
            various backgrounds. My love for the world of technology,
            especially in web and mobile development, is a driving force
            I am pursuing my dream of becoming a front-end developer and
            android developer. <br />
            <br />
            Turn ideas and creativity into a website or application
            mobile is not just a chore, it's my passion. During the trip
            me as a programmer, I don't just stop at that
            I already know, but continue to learn about technology and
            latest framework. <br />
          </div>
          <div className="flex flex-col gap-2 justify-center text-justify">
